---
title: "Kugler Lab - Home"
layout: homelay
excerpt: "Kugler Lab at the University of Cologne."
sitemap: false
permalink: /
---

**News: Our group moved to the University of Cologne (UzK)!** Join us! 
...
<div markdown="0" id="carousel" class="carousel slide" data-ride="carousel" data-interval="4000" data-pause="hover" >
    ...
    <div class="carousel-inner" markdown="0">
        <div class="item active">
            <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/slider7001400/QPI_Rh.jpg" alt="Slide 1" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/slider7001400/SmartTipSide.jpg" alt="Slide 2" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/slider7001400/SaphireSTM2.jpg" alt="Slide 3" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/slider7001400/lab.jpg" alt="Slide 4" />
        </div>
        <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/slider7001400/Fig_Science_Web.jpg" alt="Slide 5" />
        </div>       
         <div class="item">
            <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/slider7001400/BSCCO2gap2.jpg" alt="Slide 6" />
        </div>
    </div>
...
<figure class="fifth">
  <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/logopic/LMU_logo.png" style="width: 130px">
  <img src="{{ site.url }}{{ site.baseurl }}/fkugler/images/logopic/Logo_thp.svg" style="width: 140px">
</figure>
